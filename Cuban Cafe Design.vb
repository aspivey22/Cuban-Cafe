Public Class Form1
    ...
    Const intMAXFOODITEMS As Integer = 9

    Private Sub ProcessOrder(ByVal sender As System.Object, ByVal e As System.EventArgs) _
        Handles btnNewOrder.Click, btnItem0.Click, btnItem1.Click, btnItem2.Click, btnItem3.Click, btnItem4.Click, btnItem5.Click, btnItem6.Click, btnItem7.Click, btnItem8.Click
